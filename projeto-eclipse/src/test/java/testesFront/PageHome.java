...
public class PageHome {
	...
	public void testeInterface() {
		...
		//driver.findElement(By.id("mat-input-1")).sendKeys("123.456.789-01");
		//driver.findElement(By.id("mat-input-2")).sendKeys("Nome Sobrenome");
		//driver.findElement(By.id("mat-input-3")).sendKeys("15/01/2010");
		//driver.findElement(By.id("mat-input-4")).sendKeys("(16) 2222-2222");
